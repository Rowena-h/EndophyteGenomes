...
~/funannotate_latest.sif funannotate sort \
	-i ../repeat_masking/${STRAIN}_masked/${STRAIN}_${ASSEMBLER}_polished_filtered_nocontam_ncbi.fa.masked \
	-o ../repeat_masking/${STRAIN}_masked/${STRAIN}_${ASSEMBLER}_polished_filtered_nocontam_ncbi.fa.masked.sorted


~/funannotate_latest.sif funannotate predict \
	-i ../repeat_masking/${STRAIN}_masked/${STRAIN}_${ASSEMBLER}_polished_filtered_nocontam_ncbi.fa.masked.sorted \
	--species "${NAME}" \
	--strain IMI${STRAIN} \
	--name ${LOCUS_TAG} \
